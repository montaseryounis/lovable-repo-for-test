...
export const Route = createFileRoute("/app/tools/reimagine")({
  component: ReimagninePage,
});

function ReimagninePage() {
  const [prompt, setPrompt] = useState("");

  return (
    <div className="p-8 max-w-4xl mx-auto">
      <h1 className="text-2xl font-bold text-foreground mb-2">Reimagine</h1>
      <p className="text-muted-foreground mb-8">Transform and reimagine existing images</p>
