...
export const Route = createFileRoute("/app/tools/flux-kontext")({
  component: FluxKontextPage,
});

function FluxKontextPage() {
  const [prompt, setPrompt] = useState("");

  return (
    <div className="p-8 max-w-4xl mx-auto">
      <h1 className="text-2xl font-bold text-foreground mb-2">Flux Kontext</h1>
      <p className="text-muted-foreground mb-8">Context-aware image editing</p>
