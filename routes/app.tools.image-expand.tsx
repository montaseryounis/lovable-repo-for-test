...
export const Route = createFileRoute("/app/tools/image-expand")({
  component: ImageExpandPage,
});

function ImageExpandPage() {
  const [dragging, setDragging] = useState(false);

  return (
    <div className="p-8 max-w-4xl mx-auto">
      <h1 className="text-2xl font-bold text-foreground mb-2">Image Expand</h1>
      <p className="text-muted-foreground mb-8">Expand image boundaries with AI</p>
      <div
