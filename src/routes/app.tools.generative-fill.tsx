...
function GenerativeFillPage() {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <h1 className="text-2xl font-bold text-foreground mb-2">Generative Fill</h1>
      <p className="text-muted-foreground mb-8">Fill image areas with AI generation</p>
      <div
